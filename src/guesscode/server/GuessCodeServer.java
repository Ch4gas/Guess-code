...
public class GuessCodeServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            registry.rebind(SERVICE_NAME, new GuessCodeServiceImpl());

            System.out.println("Servidor GuessCode iniciado.");
            System.out.println("Servico RMI: " + SERVICE_NAME);
            System.out.println("Porta: " + PORT);
        } catch (Exception exception) {
            System.err.println("Erro ao iniciar o servidor: " + exception.getMessage());
            exception.printStackTrace();
        }
    }

    private static Registry createOrFindRegistry() throws Exception {
        try {
